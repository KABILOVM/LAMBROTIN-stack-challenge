              ...
              <div className="flex-1 relative pb-24"> 
                  ...
                  {activeTab === 'home' && gameState === 'idle' && (
                      <div className="absolute inset-0 flex flex-col items-center justify-start pt-28 animate-fade-in pointer-events-auto overflow-y-auto custom-scrollbar">
                          ...
                          <div className="flex flex-col items-center gap-6">
                              ...
                              <div className="flex flex-col gap-3 w-full max-w-[280px]">
                                <button 
                                    ...
                                    className="w-full bg-white/90 backdrop-blur-md border border-slate-100 text-slate-700 px-6 py-3.5 rounded-2xl font-bold text-[10px] uppercase tracking-widest shadow-md shadow-slate-200/50 flex items-center justify-center gap-3 active:scale-[0.98] transition-all hover:bg-white"
                                >
                          ...
                          {activeCode && (
                             <div className="mt-4 mb-4 bg-blue-50 text-blue-600 px-4 py-1.5 rounded-lg text-[10px] font-bold border border-blue-100 uppercase tracking-widest shadow-sm shadow-blue-100 animate-fade-in">
