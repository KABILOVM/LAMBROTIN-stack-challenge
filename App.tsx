...
function App() {
  ...
  return (
    <div className="w-full h-full relative bg-slate-100 overflow-hidden font-sans antialiased">
                  ...
                  {activeTab === 'home' && gameState === 'idle' && (
                      <div className="absolute inset-0 flex flex-col items-center justify-start pt-28 animate-fade-in pointer-events-auto">
                          ...
                          <div className="flex flex-col items-center gap-8">
                              ...
                              {/* NEW: Send Invoice Button on Main Screen */}
                              <button 
                                onClick={() => setShowInvoiceModal(true)}
                                className="bg-white/90 backdrop-blur-md border border-slate-200 text-slate-700 px-6 py-3.5 rounded-full font-bold text-[10px] uppercase tracking-[0.2em] shadow-xl shadow-slate-200/50 flex items-center gap-3 active:scale-95 transition-all hover:bg-white"
                              >
