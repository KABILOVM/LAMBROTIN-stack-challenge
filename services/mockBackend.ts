...
class MockBackendService {
  ...
  async getUserUnusedCodes(userId: string): Promise<PromoCode[]> {
    const { data, error } = await supabase
        .from('promo_codes')
        .select('code, is_used, is_issued, assigned_to, generated_at, invoice_number, purchase_amount')
  ...
  async issueCodesToUser(userId: string, qty: number, invoice: string, amount: number, selectedTier?: PrizeTier) {
