...
class MockBackendService {
  ...
  async getAdminStats() {
    ...
    const { data: users } = await supabase.from('users').select('id, name, city, phone, registered_at, claimed_prizes, delivery_requested').order('registered_at', { ascending: false });
