    ...
    return (
        <div className="w-full h-full bg-slate-50 flex flex-col items-center justify-center p-6 antialiased">
            ...
            <div className="grid grid-cols-2 gap-4 w-full max-w-sm">
                <button 
                    onClick={() => onSelect('ru')}
                    className="group bg-white p-6 rounded-[32px] shadow-sm border border-slate-100 transition-all duration-300 flex flex-col items-center hover:border-blue-200 hover:shadow-md hover:bg-blue-50/30 active:scale-95"
                >
