        ...
        <div className="w-full min-h-full bg-slate-50 flex flex-col items-center justify-center p-4 md:p-6 antialiased overflow-y-auto">
            <div className="w-full max-w-md bg-white rounded-[40px] md:rounded-[56px] p-8 md:p-10 shadow-2xl shadow-slate-200 border border-slate-100 animate-fade-in flex flex-col items-center relative overflow-y-auto max-h-[95vh] custom-scrollbar mb-4">
                ...
                <div className="mb-6 flex bg-slate-100/50 p-1 rounded-full border border-slate-100 shadow-sm z-10 shrink-0">
                    <button onClick={() => setLang('ru')} className={`px-6 py-2 rounded-full text-[11px] font-black transition-all ${lang === 'ru' ? 'bg-white shadow-sm text-slate-800' : 'text-slate-400'}`}>RU</button>
                    <button onClick={() => setLang('tg')} className={`px-6 py-2 rounded-full text-[11px] font-black transition-all ${lang === 'tg' ? 'bg-white shadow-sm text-slate-800' : 'text-slate-400'}`}>TJ</button>
                </div>
                ...
                <a 
                    ...
                    className="w-full py-4 mt-6 bg-slate-50 text-slate-500 rounded-2xl font-black text-[10px] uppercase tracking-widest flex items-center justify-center gap-3 border border-slate-100 hover:bg-slate-100 transition-all active:scale-[0.98] z-10"
                >
